...
//        m_values({"LV_TABVIEW_BTNS_POS_TOP", "LV_TABVIEW_BTNS_POS_BOTTOM",
...
//  QStringList function(LVGLObject *obj) const {
//    return QStringList() << QString("lv_tabview_set_btns_hidden(%1, %2);")
//                                .arg(obj->codeName())
...
//    return lv_tabview_get_btns_hidden(obj->obj());
//  }
//  void set(LVGLObject *obj, bool boolean) {
//    lv_tabview_set_btns_hidden(obj->obj(), boolean);
//  }
//};
...
//  QStringList function(LVGLObject *obj) const {
//    return QStringList() << QString("lv_tabview_set_sliding(%1, %2);")
//                                .arg(obj->codeName())
//                                .arg(QVariant(get(obj)).toString());
//  }
...
//  } void set(LVGLObject *obj, bool boolean) {
//    lv_tabview_set_sliding(obj->obj(), boolean);
//  }
//};
...
LVGLTabview::LVGLTabview() {
  ...
  m_editableStyles << LVGL::Button;      // LV_TABVIEW_PART_TAB_BTN
