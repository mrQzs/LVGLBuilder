...
LVGLObject::~LVGLObject() { lv_obj_del(m_obj); }
...
QJsonArray LVGLObject::jsonStyles() const {
  ...
  for (auto it = m_styles.begin(); it != m_styles.end(); ++it) {
    ...
    if (editableParts & LVGL::Body) {
      QJsonObject body;
      if (!defaultStyle ||
          (defaultStyle->body.main_color.full != objStyle.body.main_color.full))
        body.insert(
            "main_color",
            QVariant(lvgl.toColor(objStyle.body.main_color)).toString());
      if (!defaultStyle ||
          (defaultStyle->body.grad_color.full != objStyle.body.grad_color.full))
        body.insert(
            "grad_color",
            QVariant(lvgl.toColor(objStyle.body.grad_color)).toString());
      ...
      if (editableParts & LVGL::BodyBorder) {
        QJsonObject border;
        if (!defaultStyle || (defaultStyle->body.border.color.full !=
                              objStyle.body.border.color.full))
          border.insert(
              "color",
              QVariant(lvgl.toColor(objStyle.body.border.color)).toString());
        if (!defaultStyle ||
            (defaultStyle->body.border.width != objStyle.body.border.width))
          border.insert("width", objStyle.body.border.width);
        if (!defaultStyle ||
            (defaultStyle->body.border.part != objStyle.body.border.part))
          border.insert("part", objStyle.body.border.part);
        if (!defaultStyle ||
            (defaultStyle->body.border.opa != objStyle.body.border.opa))
      ...
      if (editableParts & LVGL::BodyShadow) {
        QJsonObject shadow;
        if (!defaultStyle || (defaultStyle->body.shadow.color.full !=
                              objStyle.body.shadow.color.full))
          shadow.insert(
              "color",
              QVariant(lvgl.toColor(objStyle.body.shadow.color)).toString());
        if (!defaultStyle ||
            (defaultStyle->body.shadow.width != objStyle.body.shadow.width))
          shadow.insert("width", objStyle.body.border.width);
        if (!defaultStyle ||
            (defaultStyle->body.shadow.type != objStyle.body.shadow.type))
      ...
      if (editableParts & LVGL::BodyPadding) {
        QJsonObject padding;
        if (!defaultStyle ||
            (defaultStyle->body.padding.top != objStyle.body.padding.top))
          padding.insert("top", objStyle.body.padding.top);
        if (!defaultStyle ||
            (defaultStyle->body.padding.bottom != objStyle.body.padding.bottom))
          padding.insert("bottom", objStyle.body.padding.bottom);
        if (!defaultStyle ||
            (defaultStyle->body.padding.left != objStyle.body.padding.left))
          padding.insert("left", objStyle.body.padding.left);
        if (!defaultStyle ||
            (defaultStyle->body.padding.right != objStyle.body.padding.right))
          padding.insert("right", objStyle.body.padding.right);
        if (!defaultStyle ||
            (defaultStyle->body.padding.inner != objStyle.body.padding.inner))
          padding.insert("inner", objStyle.body.padding.inner);
        if (!padding.isEmpty()) body.insert("padding", padding);
      }
      if (!body.isEmpty()) style.insert("body", body);
    }

    if (editableParts & LVGL::Text) {
      QJsonObject text;
      if (!defaultStyle ||
          (defaultStyle->text.color.full != objStyle.text.color.full))
        text.insert("color",
                    QVariant(lvgl.toColor(objStyle.text.color)).toString());
      if (!defaultStyle ||
          (defaultStyle->text.sel_color.full != objStyle.text.sel_color.full))
        text.insert("sel_color",
                    QVariant(lvgl.toColor(objStyle.text.sel_color)).toString());
      if (!defaultStyle || (defaultStyle->text.font != objStyle.text.font))
        text.insert("font", lvgl.fontName(objStyle.text.font));
      if (!defaultStyle ||
          (defaultStyle->text.letter_space != objStyle.text.letter_space))
        text.insert("letter_space", objStyle.text.letter_space);
      if (!defaultStyle ||
          (defaultStyle->text.line_space != objStyle.text.line_space))
    ...
    if (editableParts & LVGL::Image) {
      QJsonObject image;
      if (!defaultStyle ||
          (defaultStyle->image.color.full != objStyle.image.color.full))
        image.insert("color",
                     QVariant(lvgl.toColor(objStyle.image.color)).toString());
      if (!defaultStyle ||
          (defaultStyle->image.intense != objStyle.image.intense))
    ...
    if (editableParts & LVGL::Line) {
      QJsonObject line;
      if (!defaultStyle ||
          (defaultStyle->line.color.full != objStyle.line.color.full))
        line.insert("color",
                    QVariant(lvgl.toColor(objStyle.line.color)).toString());
...
QStringList LVGLObject::codeStyle(QString styleVar, int type) const {
  ...
  if (editableParts & LVGL::Body) {
    if (!defaultStyle ||
        (defaultStyle->body.main_color.full != objStyle.body.main_color.full)) {
      QString color = QVariant(lvgl.toColor(objStyle.body.main_color))
                          .toString()
                          .replace("#", "0x");
    ...
    if (!defaultStyle ||
        (defaultStyle->body.grad_color.full != objStyle.body.grad_color.full)) {
      QString color = QVariant(lvgl.toColor(objStyle.body.grad_color))
                          .toString()
                          .replace("#", "0x");
    ...
    if (!defaultStyle || (defaultStyle->body.radius != objStyle.body.radius))
      ret << styleVar +
                 ".body.radius = " + QString::number(objStyle.body.radius) +
                 ";";
    if (!defaultStyle || (defaultStyle->body.opa != objStyle.body.opa))
    ...
    if (editableParts & LVGL::BodyBorder) {
      if (!defaultStyle || (defaultStyle->body.border.color.full !=
                            objStyle.body.border.color.full)) {
        QString color = QVariant(lvgl.toColor(objStyle.body.border.color))
                            .toString()
                            .replace("#", "0x");
      ...
      if (!defaultStyle ||
        ...
        ret << styleVar + ".body.border.width = " +
                   QString::number(objStyle.body.border.width) + ";";
      if (!defaultStyle ||
          (defaultStyle->body.border.part != objStyle.body.border.part))
        ret << styleVar + ".body.border.part = " +
                   QString::number(objStyle.body.border.part) + ";";
      if (!defaultStyle ||
          (defaultStyle->body.border.opa != objStyle.body.border.opa))
        ret << styleVar + ".body.border.opa = " +
                   QString::number(objStyle.body.border.opa) + ";";
    }
    ...
    if (editableParts & LVGL::BodyShadow) {
      ...
      if (!defaultStyle || (defaultStyle->body.shadow.color.full !=
                            objStyle.body.shadow.color.full)) {
        QString color = QVariant(lvgl.toColor(objStyle.body.shadow.color))
                            .toString()
                            .replace("#", "0x");
      ...
      if (!defaultStyle ||
        ...
        ret << styleVar + ".body.shadow.width = " +
                   QString::number(objStyle.body.shadow.width) + ";";
      if (!defaultStyle ||
          (defaultStyle->body.shadow.type != objStyle.body.shadow.type))
        ret << styleVar + ".body.shadow.type = " +
                   QString::number(objStyle.body.shadow.type) + ";";
    }
    ...
    if (editableParts & LVGL::BodyPadding) {
      ...
      if (!defaultStyle ||
        ...
        ret << styleVar + ".body.padding.top = " +
                   QString::number(objStyle.body.padding.top) + ";";
      if (!defaultStyle ||
          (defaultStyle->body.padding.bottom != objStyle.body.padding.bottom))
        ret << styleVar + ".body.padding.bottom = " +
                   QString::number(objStyle.body.padding.bottom) + ";";
      if (!defaultStyle ||
          (defaultStyle->body.padding.left != objStyle.body.padding.left))
        ret << styleVar + ".body.padding.left = " +
                   QString::number(objStyle.body.padding.left) + ";";
      if (!defaultStyle ||
          (defaultStyle->body.padding.right != objStyle.body.padding.right))
        ret << styleVar + ".body.padding.right = " +
                   QString::number(objStyle.body.padding.right) + ";";
      if (!defaultStyle ||
          (defaultStyle->body.padding.inner != objStyle.body.padding.inner))
        ret << styleVar + ".body.padding.inner = " +
                   QString::number(objStyle.body.padding.inner) + ";";
    }
  }
  ...
  if (editableParts & LVGL::Text) {
    if (!defaultStyle ||
        (defaultStyle->text.color.full != objStyle.text.color.full)) {
      QString color = QVariant(lvgl.toColor(objStyle.text.color))
                          .toString()
                          .replace("#", "0x");
    ...
    if (!defaultStyle ||
        (defaultStyle->text.sel_color.full != objStyle.text.sel_color.full)) {
      QString color = QVariant(lvgl.toColor(objStyle.text.sel_color))
                          .toString()
                          .replace("#", "0x");
    ...
    if (!defaultStyle || (defaultStyle->text.font != objStyle.text.font))
      ret << styleVar + ".text.font = &" +
                 lvgl.fontCodeName(objStyle.text.font) + ";";
    if (!defaultStyle ||
        (defaultStyle->text.letter_space != objStyle.text.letter_space))
      ret << styleVar + ".text.letter_space = " +
                 QString::number(objStyle.text.letter_space) + ";";
    if (!defaultStyle ||
        (defaultStyle->text.line_space != objStyle.text.letter_space))
      ret << styleVar + ".text.line_space = " +
                 QString::number(objStyle.text.line_space) + ";";
    if (!defaultStyle || (defaultStyle->text.opa != objStyle.text.opa))
  ...
  if (editableParts & LVGL::Image) {
    if (!defaultStyle ||
        (defaultStyle->image.color.full != objStyle.image.color.full)) {
      QString color = QVariant(lvgl.toColor(objStyle.image.color))
                          .toString()
                          .replace("#", "0x");
    ...
    if (!defaultStyle ||
        (defaultStyle->image.intense != objStyle.image.intense))
      ret << styleVar +
                 ".image.intense = " + QString::number(objStyle.image.intense) +
                 ";";
    if (!defaultStyle || (defaultStyle->image.opa != objStyle.image.opa))
  ...
  if (editableParts & LVGL::Line) {
    if (!defaultStyle ||
        (defaultStyle->line.color.full != objStyle.line.color.full)) {
      QString color = QVariant(lvgl.toColor(objStyle.line.color))
                          .toString()
                          .replace("#", "0x");
    ...
    if (!defaultStyle || (defaultStyle->line.width != objStyle.line.width))
      ret << styleVar +
                 ".line.width = " + QString::number(objStyle.line.width) + ";";
    if (!defaultStyle || (defaultStyle->line.opa != objStyle.line.opa))
  ...
  for (int i = 0; i < styles.size(); ++i) {
    ...
    if (style.contains("body")) {
      ...
      if (body.contains("border")) {
        ...
        if (border.contains("width"))
          objStyle->body.border.width =
              static_cast<lv_coord_t>(border["width"].toInt());
        if (border.contains("part"))
          objStyle->body.border.part =
              static_cast<lv_border_part_t>(border["part"].toInt());
        if (border.contains("opa"))
          objStyle->body.border.opa =
              static_cast<lv_opa_t>(border["opa"].toInt());
      }
      ...
      if (body.contains("shadow")) {
        ...
        if (shadow.contains("width"))
          objStyle->body.shadow.width =
              static_cast<lv_coord_t>(shadow["width"].toInt());
        if (shadow.contains("type"))
          objStyle->body.shadow.type =
              static_cast<lv_shadow_type_t>(shadow["type"].toInt());
      }

      if (body.contains("padding")) {
        QJsonObject padding = body["padding"].toObject();
        if (padding.contains("top"))
          objStyle->body.padding.top =
              static_cast<lv_coord_t>(padding["top"].toInt());
        if (padding.contains("bottom"))
          objStyle->body.padding.bottom =
              static_cast<lv_coord_t>(padding["bottom"].toInt());
        if (padding.contains("left"))
          objStyle->body.padding.left =
              static_cast<lv_coord_t>(padding["left"].toInt());
        if (padding.contains("right"))
          objStyle->body.padding.right =
              static_cast<lv_coord_t>(padding["right"].toInt());
        if (padding.contains("inner"))
          objStyle->body.padding.inner =
    ...
    if (style.contains("image")) {
      ...
      if (image.contains("intense"))
        objStyle->image.intense =
            static_cast<lv_opa_t>(image["intense"].toInt());
...
lv_style_t *LVGLObject::style(int type) {
  if (m_styles.contains(type)) return &m_styles[type];
